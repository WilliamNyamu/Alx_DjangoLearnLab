...
SECRET_KEY = 'django-insecure-5ew2jn*1f!#-7rzl@8kb5gftc8#v-8y6t8a#v-l9m1@ylzpidk'
...
STATIC_URL = 'static/'
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' # (just copied from a repo)
